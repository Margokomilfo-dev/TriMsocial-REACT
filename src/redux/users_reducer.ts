...
export const toggleFollowingInProcess = (isLoader: boolean, userId: number): ToggleFollowingInProcessActionType => ({
...
export const setFriendsData = (name: string, src: string): SetFriendsDataActionType => ({
    type: SET_FRIENDS,
    data: {name, src}
});
